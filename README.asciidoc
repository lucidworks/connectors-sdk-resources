...
For developing a Java SDK based connector, check out the link:https://github.com/lucidworks/connectors-sdk-resources/blob/v2.0.1/java-sdk/README.asciidoc[Java SDK^].
...
| 5.1.2 | link:https://github.com/lucidworks/connectors-sdk-resources/releases/tag/v2.0.1[2.0.1^]
|====================================================
