...
| 5.8.x| link:https://github.com/lucidworks/connectors-sdk-resources/tree/v4.1.4[4.1.4]
...
| 5.3.x | link:https://github.com/lucidworks/connectors-sdk-resources/tree/v3.0.0[3.0.0]
