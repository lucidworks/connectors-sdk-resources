...
For developing a Java SDK based connector, check out the link:java-sdk/README.asciidoc[README].

The repository includes https://github.com/lucidworks/connectors-sdk-resources/tree/master/java-sdk/connectors[a Gradle project^] which wraps each https://github.com/lucidworks/connectors-sdk-resources/blob/master/java-sdk/connectors/settings.gradle[known plugin^] with a common set of tasks and dependencies.

See the example link:java-sdk/connectors/random-connector/README.asciidoc[Random Content Connector] for instructions on how to build, deploy and run.
...
The link:./java-sdk/README.html[Java SDK] includes a set of base classes and interfaces. It also provides the Gradle build utilities for packaging up a connector,
