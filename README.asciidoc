...
| 5.18.x| link:https://github.com/lucidworks/connectors-sdk-resources/tree/v4.2.5[4.2.5]
| 5.17.x| link:https://github.com/lucidworks/connectors-sdk-resources/tree/v4.2.3[4.2.3]
...
| 5.9.16| link:https://github.com/lucidworks/connectors-sdk-resources/tree/v4.2.2[4.2.2]
| 5.9.11 - 5.9.15| link:https://github.com/lucidworks/connectors-sdk-resources/tree/v4.2.1[4.2.1]
