...
For developing a Java SDK based connector, check out the link:https://github.com/lucidworks/connectors-sdk-resources/blob/v2.0.3/java-sdk/README.asciidoc[Java SDK^].
...
| 5.2.1 - 5.2.x | link:https://github.com/lucidworks/connectors-sdk-resources/releases/tag/v2.0.3[2.0.3^]
