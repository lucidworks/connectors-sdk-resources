...
For developing a Java SDK based connector, check out the link:https://github.com/lucidworks/connectors-sdk-resources/blob/v2.0.2/java-sdk/README.asciidoc[Java SDK README^].
...
See the link:https://github.com/lucidworks/connectors-sdk-resources/blob/v2.0.2/java-sdk/connectors/simple-connector/README.asciidoc[Random Connector^] example for instructions on how to build, deploy and run.
...
| 5.2.0 | link:https://github.com/lucidworks/connectors-sdk-resources/releases/tree/v2.0.2[2.0.2^]
|====================================================
