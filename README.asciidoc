...
The repository includes https://github.com/lucidworks/connectors-sdk-resources/tree/2.0.3/java-sdk/connectors[a Gradle project^],
which wraps each https://github.com/lucidworks/connectors-sdk-resources/blob/2.0.3/java-sdk/connectors/settings.gradle[known plugin^] with a common set of tasks and dependencies.
