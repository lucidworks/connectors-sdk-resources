...
import com.lucidworks.fusion.connector.plugin.LabConnectorGenerator;
import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class DefaultGenerator implements LabConnectorGenerator {

  private static DefaultGenerator sInstance;
  ...
  public static synchronized DefaultGenerator getInstance() {
    if (sInstance == null) {
      sInstance = new DefaultGenerator();
    }
    return sInstance;
  }
