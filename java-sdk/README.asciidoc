...
The simplest way to get started developing a connector is to review the https://github.com/lucidworks/connectors-sdk-resources/tree/v3.0.0/java-sdk/connectors/simple-connector[Simple Connector^].
