...
. See the following link:https://github.com/lucidworks/connectors-sdk-resources/blob/v2.0.2/java-sdk/connectors/README.md[instructions^] on how to build, deploy, and run the plugin.
