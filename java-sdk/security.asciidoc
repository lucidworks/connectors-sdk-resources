...
ifndef::env-github[]
link:/how-to/configure-remote-connectors-security.html[custom connector security overview]
endif::[]
...
ifndef::env-github[]
link:/how-to/java-connector-dev.html#plugin-client[plugin-client]
endif::[]
