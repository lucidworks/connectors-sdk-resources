...
See the main link:../security.asciidoc[custom connector security overview] for instructions on how to configure SSL/TLS support for a Fusion custom connector.
